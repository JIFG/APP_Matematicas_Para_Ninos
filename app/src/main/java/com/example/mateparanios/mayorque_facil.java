...
public class mayorque_facil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mayorque_facil);
...
public void vidas(){
    ...
    public void mostrarDialogoPersonalizado(){
        ...
        AlertDialog.Builder builder= new AlertDialog.Builder(mayorque_facil.this);
