...
public class Restas2medio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restas2medio);
    ...
    public void aleatorios(){
        var1 = (int) Math.floor(Math.random()*(50-1+1)+30);
        var2 = (int) Math.floor(Math.random()*(30-1+1)+1);
        var3 = (int) Math.floor(Math.random()*(30-1+1)+1);
        var4 = (int) Math.floor(Math.random()*(30-1+1)+1);
        var5 = (int) Math.floor(Math.random()*(30-1+1)+1);
    ...
    public void mostrarDialogoPersonalizado(){
        ...
        AlertDialog.Builder builder= new AlertDialog.Builder(Restas2medio.this);
        ...
        btncontinuar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mayorquemedio= new Intent(getApplicationContext(),mayorque_medio.class);
                string_vidas= String.valueOf(vidas);
                mayorquemedio.putExtra("vidas",string_vidas);
                startActivity(mayorquemedio);
                finish();
                mp.stop();
                mp.release();
            }
