...
public class Sumas1medio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sumas1medio);
        ...
        iv_aciertos=findViewById(R.id.iv_aciertos);
        aleatorios();
        ordenbtns();
    ...
    public void aleatorios(){
        ...
        var4 = (int) Math.floor(Math.random()*(50-1+1)+1);
        var5 = (int) Math.floor(Math.random()*(50-1+1)+1);
        res1=var1+var2;
    ...
    public void mostrarDialogoPersonalizado(){
        ...
        AlertDialog.Builder builder= new AlertDialog.Builder(Sumas1medio.this);
        ...
        btncontinuar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sumas2= new Intent(getApplicationContext(),Sumas2medio.class);
                string_vidas= String.valueOf(vidas);
                sumas2.putExtra("vidas",string_vidas);
                startActivity(sumas2);
                finish();
                mp.stop();
                mp.release();
            }
